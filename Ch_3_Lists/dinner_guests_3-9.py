...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  8 21:14:10 2018
...
#use len to print a message indicating the number of people invited to dinner
print("I am inviting " + str(len(guests)) + " guests.")
