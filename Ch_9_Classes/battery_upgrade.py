...
Use the final version of electric_car.py from this section. x
...
class Battery():
    ...
    def upgrade_battery(self):
        """Checks battery size and sets the capacity to 85 if it isn't already"""
        if self.battery_size == 85:
            print("\nThe battery size is currently set to 85.")
        elif self.battery_size != 85:
